...
<h1>Verifikasi Survey</h1>

<c:url var="saveUrl" value="surveyedit.htm" />
<form:form modelAttribute="surveyAttribute" method="POST" action="${saveUrl}">
	<table style="width: 100%">
		...
		<tr>
			<td><form:label path="jumlahIzinBelumVerifikasi">Jumlah Izin Belum Survey</form:label></td>
			<td>:</td>
			<td>
